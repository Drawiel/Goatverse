...
namespace Goatverse.GoatverseService {
    ...
    public interface IProfilesManager {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProfilesManager/ServiceGetWonMatchesByUsername", ReplyAction="http://tempuri.org/IProfilesManager/ServiceGetWonMatchesByUsernameResponse")]
        System.Threading.Tasks.Task<int> ServiceGetWonMatchesByUsernameAsync(string username);
    }
    ...
    public partial class ProfilesManagerClient : System.ServiceModel.ClientBase<Goatverse.GoatverseService.IProfilesManager>, Goatverse.GoatverseService.IProfilesManager {
        ...
        public void ServiceIncrementMatchesWonByUserName(string username) {
            base.Channel.ServiceIncrementMatchesWonByUserName(username);
        }
        
        public System.Threading.Tasks.Task ServiceIncrementMatchesWonByUserNameAsync(string username) {
            return base.Channel.ServiceIncrementMatchesWonByUserNameAsync(username);
        }
        
        public int ServiceGetWonMatchesByUsername(string username) {
            return base.Channel.ServiceGetWonMatchesByUsername(username);
        }
        
        public System.Threading.Tasks.Task<int> ServiceGetWonMatchesByUsernameAsync(string username) {
            return base.Channel.ServiceGetWonMatchesByUsernameAsync(username);
        }
    }
    ...
    public interface IMatchManager {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceUpdatePointsFromPlayer")]
        void ServiceUpdatePointsFromPlayer(string lobbyCode, string username, int points);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceUpdatePointsFromPlayer")]
        System.Threading.Tasks.Task ServiceUpdatePointsFromPlayerAsync(string lobbyCode, string username, int points);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceEndGame")]
        void ServiceEndGame(string lobbyCode);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceEndGame")]
        System.Threading.Tasks.Task ServiceEndGameAsync(string lobbyCode);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceAttackPlayers")]
        void ServiceAttackPlayers(string lobbyCode, string usernameAttacker, int attackPoints);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceAttackPlayers")]
        System.Threading.Tasks.Task ServiceAttackPlayersAsync(string lobbyCode, string usernameAttacker, int attackPoints);
    }
    ...
    public interface IMatchManagerCallback {
        ...
        void ServiceUpdateCurrentTurn(string currentTurn, System.Collections.Generic.Dictionary<string, int> playerPoints);
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchManager/ServiceNotifyReturnToStart")]
    ...
    public partial class MatchManagerClient : System.ServiceModel.DuplexClientBase<Goatverse.GoatverseService.IMatchManager>, Goatverse.GoatverseService.IMatchManager {
        ...
        public void ServiceUpdatePointsFromPlayer(string lobbyCode, string username, int points) {
            base.Channel.ServiceUpdatePointsFromPlayer(lobbyCode, username, points);
        }
        
        public System.Threading.Tasks.Task ServiceUpdatePointsFromPlayerAsync(string lobbyCode, string username, int points) {
            return base.Channel.ServiceUpdatePointsFromPlayerAsync(lobbyCode, username, points);
        }
        
        public void ServiceEndGame(string lobbyCode) {
            base.Channel.ServiceEndGame(lobbyCode);
        }
        
        public System.Threading.Tasks.Task ServiceEndGameAsync(string lobbyCode) {
            return base.Channel.ServiceEndGameAsync(lobbyCode);
        }
        
        public void ServiceAttackPlayers(string lobbyCode, string usernameAttacker, int attackPoints) {
            base.Channel.ServiceAttackPlayers(lobbyCode, usernameAttacker, attackPoints);
        }
        
        public System.Threading.Tasks.Task ServiceAttackPlayersAsync(string lobbyCode, string usernameAttacker, int attackPoints) {
            return base.Channel.ServiceAttackPlayersAsync(lobbyCode, usernameAttacker, attackPoints);
        }
    }
